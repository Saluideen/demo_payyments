...
def get_razorpay_client():
	key_id = frappe.db.get_single_value("demo Razorpay Settings", "key_id")
	
	key_secret = get_decrypted_password(
		"demo Razorpay Settings", "demo Razorpay Settings", "key_secret"
	)
...
def create_order(name):
	...
	price_inr = frappe.db.get_value("demo_payment", name, "amount")
	order_data = {"amount": price_inr * 100, "currency": "INR"}  # convert to paisa
